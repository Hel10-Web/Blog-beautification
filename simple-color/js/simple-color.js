    ...
    var a = function() {
        ...
        },
        {
            ...
            value: function() {
				...
				n.find("li").eq(2).after('<li><a id="blog_nav_tags" class="menu" href="https://github.com/Hel10-Web?tab=repositories">GitHub</a></li>'),
				n.find("li").eq(4).after('<li><a id="blog_nav_tags" class="menu" href="https://i-beta.cnblogs.com/posts">管理</a></li>'),
				n.find("li").eq(5).after('<li><a id="blog_nav_tags" class="menu" href="https://www.shentoushi.top/index">友链</a></li>'),
                p.each(n.find("li"),
                function(e, t) {
                    p(t).append("<i></i>")
                }),
